...
export default async function ArticlePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const article = {
    ...
    summary: isZh ? '探索AI在酒店业中的应用，包括智能客服、AI预订推荐、客房环境感知等场景，以及情绪价值驱动的创新路径。' : 'Explore AI applications in hospitality, including smart客服, AI booking recommendations, room environment sensing, and emotional value driven innovation.',
    author: 'MBCT内容团队',
    date: '2026-05-15',
