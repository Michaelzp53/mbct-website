...
export default async function KnowledgePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articles = [
...

    {
      ...
      summary: "游客多了，酒店老板却更累：问题不在客流，而在酒店能不能接住家庭客、夜间消费和高峰服务压力。暑期经营先看服务承载力，再谈涨价和 RevPAR。",
      summaryEn: "More travelers can make hotel owners more tired when service capacity is not ready. Summer performance depends on whether the hotel can absorb family guests, nighttime demand, and peak service pressure.",
