...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://www.marvelbros.com/${lang}/knowledge`,
      languages: {
        zh: 'https://www.marvelbros.com/zh/knowledge',
        en: 'https://www.marvelbros.com/en/knowledge',
      },
    },
    openGraph: {
      title,
      ...
      url: `https://www.marvelbros.com/${lang}/knowledge`,
...
export default async function KnowledgePage({
  ...
  const articles = [
    ...
    },
    {
      ...
      titleEn: "Why Hotel Opening Budgets Keep Expanding: Separate These Three Cost Layers Before Trying to Cut",
      slug: "hotel-opening-budget-three-cost-layers-2026-08-09",
      summary: "预算追加通常不是某个单价单独失控，而是资产基础、产品选择和开业准备三类成本混在一起。拆层、管变更、看工期，才能知道哪些该批、哪些该停。",
      summaryEn: "Repeated budget additions rarely come from one bad unit price. Separate asset and compliance, product choice, and opening readiness before deciding what to approve.",
      firstLine: "预算越做越大，先别急着砍单价，先把三类成本分开。",
      author: "迈创兄弟C&T",
      date: "2026-08-09",
      category: "industry-insights",
      tag: isZh ? "行业分析" : "Industry Analysis",
    ...
    },
    {
      ...
      titleEn: "From Peak-Trough Demand in China to Global Investment Divergence: Where Is the Hotel Industry Heading in the Second Half of 2026?",
      slug: "china-hotel-peak-trough-global-investment-divergence-2026-08-07",
      summary: "2026年下半年酒店业不会同步回暖，而会在假期与平日、入住率与利润、国内供给与全球资本之间出现更明显分化。本文用五项指标建立未来六个月的观察框架。",
      summaryEn: "The second half of 2026 is likely to bring sharper divergence across peak and weekday demand, occupancy and profit, domestic supply and global hotel capital. Five indicators provide a practical six-month monitoring framework.",
      firstLine: "2026年下半年酒店业的主线不是同步复苏，而是需求、收益、供给和资本的进一步分化。",
      author: "迈创兄弟C&T",
      date: "2026-08-07",
      category: "industry-insights",
      tag: isZh ? "行业分析" : "Industry Analysis",
    ...
    },
    {
      ...
      titleEn: "Which Four Metric Groups Should Hotels Track to Measure AI Lead Generation?",
      slug: "four-metric-groups-for-hotel-ai-lead-generation-2026-07-18",
      summary: "设想这样一个场景：一家城市商务酒店的总经理在一次行业交流后，决定认真做 AI 获客。几周后，他打开后台数据面板，看到满屏的访问、点击、跳出率、平均停留时间——数字很多，但他不知道应该先看哪一个，也不知道哪些数字变了才算\"有效果\"。",
      summaryEn: "Walk into most hotel review meetings and you will find a strange thing. Everyone has data, and everyone is looking at a different number. The marketing lead points to search visibility and site visits. The front office talks about occupancy. The sales team counts inquiries. Finance reads ADR and RevPAR. Each is correct in isolation, and yet no one in the room can trace a single guest from AI discovery all the way to a booked, paid stay.",
      firstLine: "设想这样一个场景：一家城市商务酒店的总经理在一次行业交流后，决定认真做 AI 获客。几周后，他打开后台数据面板，看到满屏的访问、点击、跳出率、平均停留时间——数字很多，但他不知道应该先看哪一个，也不知道哪些数字变了才算\"有效果\"。",
      author: "迈创兄弟C&T",
      date: "2026-07-18",
      readTime: 6,
      tag: isZh ? "管享精道" : "Lean Insights",
      tagColor: "bg-[#0ea5e9]",
      tagTextColor: "text-white",
      featured: true,
    },
    {
      id: 622,
      type: "article",
      title: "酒店如何验证 AI 获客是否真正提升了 RevPAR？",
      titleEn: "How Can Hotels Verify Whether AI Lead Generation Is Actually Improving RevPAR?",
      slug: "how-hotels-verify-ai-lead-generation-improves-revpar-2026-07-18",
      summary: "一个常见的经营复盘场景：一家度假酒店在尝试 AI 获客后，官网访问量和搜索展示都在上涨。市场团队拿着报表走进月度经营会时，每个人脸上都带着期待——直到财务总监抬头问了一句：\"那么 RevPAR 涨了多少？\"",
      summaryEn: "Consider a common operating-review scenario. Search-driven and AI-driven visits are up. The website looks busier. More people are landing on the rooms page, the meeting-space page, and the restaurant page. On the surface, AI hotel lead generation appears to be working.",
      firstLine: "一个常见的经营复盘场景：一家度假酒店在尝试 AI 获客后，官网访问量和搜索展示都在上涨。市场团队拿着报表走进月度经营会时，每个人脸上都带着期待——直到财务总监抬头问了一句：\"那么 RevPAR 涨了多少？\"",
      author: "迈创兄弟C&T",
      date: "2026-07-18",
      readTime: 6,
      tag: isZh ? "行业分析" : "Industry Analysis",
    ...
    },
    {
      id: 621,
      type: "article",
      title: "酒店做 AI 获客，成本该怎样和传统获客比较？",
      titleEn: "How Should Hotels Compare AI Lead Generation Costs with Traditional Marketing?",
      slug: "hotel-ai-lead-generation-cost-vs-traditional-marketing-2026-07-17",
      summary: "很多酒店老板听到 AI 获客，第一反应不是要不要做，而是会不会又是一笔看不见结果的钱。",
      summaryEn: "When hotel owners hear about AI lead generation, their first concern is often not whether to do it, but whether it will become another expense with no visible return.",
      firstLine: "很多酒店老板听到 AI 获客，第一反应不是\"要不要做\"，而是\"会不会又是一笔看不见结果的钱\"。",
      author: "迈创兄弟C&T",
      date: "2026-07-17",
      readTime: 6,
      tag: isZh ? "行业分析" : "Industry Analysis",
    ...
    id: 617,
    type: "article",
    title: "AI 推荐酒店后，客人为什么不愿直接联系酒店或在酒店平台下单？",
    titleEn: "If AI Recommends a Hotel, Why Do Guests Still Avoid Booking Direct?",
    slug: "hotel-ai-recommendation-guest-avoid-direct-booking-2026-07-11",
    summary: "AI 推荐解决了“被看见”的问题，但从被看见到被选择，中间隔着价格透明度、手机端体验、推荐说服力、官网可信度、联系安全感和直接行动理由六个判断。任何一个环节让客人犹豫，他就会回到最熟悉的 OTA 渠道。",
    summaryEn: "AI recommendation solves the visibility problem, but between being seen and being chosen lie six judgments: price transparency, mobile experience, recommendation persuasiveness, website credibility, contact safety, and a clear reason to act directly.",
    firstLine: "想象一个场景。一位商务旅客在出差前问 AI：“上海静安寺附近有什么适合商务出行的酒店？”AI 给出了三家推荐，其中一家是你的酒店。客人点开了其中一家的链接，看了几分钟，然后关掉了页面，回到 OTA 平台下了单。",
    author: "迈创兄弟C&T",
    date: "2026-07-11",
    category: "industry-insights",
    tag: isZh ? "行业分析" : "Industry Analysis",
    ...
    content: [
      ...
      "想象一个场景。一位商务旅客在出差前问 AI：\"上海静安寺附近有什么适合商务出行的酒店？\"AI 给出了三家推荐，其中一家是你的酒店。客人点开了其中一家的链接，看了几分钟，然后关掉了页面，回到 OTA 平台下了单。",
      "问题出在哪里？AI 推荐没有效果吗？",
      "未必。更可能的情况是，客人在那几分钟里遇到了一些让他犹豫的事情。这些事情单独看都不大，但加在一起，足以让他放弃直接联系你或在你的官网预订。",
      "他首先想到的是价格。AI 推荐里没有提到价格，你的官网上写着\"最优价格保证\"，但他不知道这个\"最优\"是跟谁比。OTA 上能看到各种套餐、会员价、限时优惠，他习惯了在那里比较。直接在你的官网下单，他担心自己错过了更划算的选择。这种担心不是没有道理——很多酒店官网的价格确实不够透明，权益说明也不清楚。客人宁可多花五分钟在 OTA 上反复对比，也不愿意冒\"买贵了\"的风险。",
      "然后他看了看手机端体验。你的官网在电脑上打开挺漂亮，但在手机上，预订入口藏得有点深，表单填到一半发现不能返回修改，加载速度也不快。他试了一下，觉得有点麻烦。更关键的是，他不习惯输入英文网址。他平时找酒店都是通过搜索引擎、地图或者小程序，你的官网入口没有出现在这些他熟悉的地方。他自然会选择最顺手的方式——回到 OTA。",
      "他还注意到，AI 推荐里只说了你的酒店\"位置优越\"\"设施完善\"，但没有告诉他具体好在哪里。适不适合带老人？商务出差网络快不快？跟隔壁那家同价位的酒店比有什么优势？这些问题 AI 没有回答，你的官网首屏也只是一句\"奢华体验\"的口号和一张看不出特色的大图。他找不到一个非选你不可的理由。",
      "他继续往下翻，看到了酒店自己写的介绍。照片很精美，文字全是优点，限制条件藏在角落。他一眼就看出这是广告。他刚刚在 OTA 上看过几十条真实住客评价，现在看到这种只说好话的内容，信任感大打折扣。如果官网不能提供可验证的信息——比如真实的房型参数、最近的翻新时间、明确的餐饮价格——他会觉得这里只是另一个\"说好话\"的地方，不值得留下联系方式。",
      "他开始考虑要不要打个电话问问。但他想到几个问题：电话谁来接？多久能回复？订单怎么确认？取消和退款怎么处理？支付安不安全？OTA 平台至少有一套他熟悉的订单确认和客服体系，直接联系酒店意味着承担更多不确定性。如果酒店不能给出同等的确定性，直接联系就变成了风险更高的选择。",
      "最后他问自己：为什么要直接找酒店？在 OTA 上预订，流程熟悉、信息齐全、评价丰富、售后有保障。直接联系酒店或在官网下单能带来什么明显好处吗？更清晰的价格优势？更独特的权益？更快的响应？更个性化的服务？如果这些问题没有清楚的答案，他没有理由改变习惯。",
      "这就是问题所在。AI 推荐解决了\"被看见\"的问题，但从\"被看见\"到\"被选择\"，中间隔着很多细小的判断。价格是否透明？手机端是否方便？推荐内容是否有说服力？官网内容是否可信？联系是否安全？直接行动是否有明显好处？任何一个环节让客人犹豫，他就会回到最熟悉的渠道。",
      "酒店需要检查的不是\"AI 有没有推荐我\"，而是\"客人看到推荐之后，为什么没有下一步动作\"。这五层检查可以帮你看清问题出在哪里：AI 能不能准确找到你？推荐内容能不能迅速说清为什么选你？你的信息和价格有没有可信证据？客人有没有理由直接联系你？手机端能不能低成本、安全地完成咨询或预订？",
      "这五层环环相扣。前面做得再好，后面接不住，客人还是会流失。",
      "迈创兄弟C&T在酒店 AI 可见度与直订承接领域，可以帮助酒店完成从 AI 信息体检、官网信息结构优化、咨询与直订承接设计到持续托管的完整建设，让酒店在 AI 时代不仅被看见，更能被选择。",
      "常见问题",
      "AI 推荐酒店后，客人为什么不愿直接联系酒店？\n多数情况下，不是推荐没有效果，而是酒店在价格透明度、联系安全感和移动端体验上没有给客人足够的行动理由。",
      "客人为什么不相信酒店官网的价格？\n如果官网只写\"最低价\"却没有清楚的价格构成和权益说明，客人无法判断这个价格是否真的值得信任。",
      "酒店官网手机版为什么会影响直接预订？\n加载慢、入口难找、表单复杂、不支持常用支付方式，任何一个细节都会让客人在最后一步放弃。",
      "AI 推荐能直接给酒店带来订单吗？\nAI 推荐解决的是\"被看见\"的问题。从被看见到被选择，还需要酒店在价格、信任、体验和承接上做好完整准备。"
],
    contentEn: [
      ...
      "迈创兄弟C&T helps hotels build the complete pathway from AI visibility to direct conversion, including AI information audits, website structure optimization, inquiry and booking experience design, and ongoing management, so that being seen by AI actually leads to being chosen by guests.",
      "Frequently Asked Questions",
      "Why do guests not contact the hotel directly after AI recommends it?\nIn most cases, the recommendation works. The gap is in price transparency, contact safety, and mobile experience. The hotel has not given guests a strong enough reason to act.",
      "Why do guests not trust the hotel website pricing?\nIf the website only claims \"best price\" without clear price breakdowns and benefit explanations, guests cannot judge whether the price is genuinely trustworthy.",
      "Why does the mobile version of the hotel website affect direct bookings?\nSlow loading, hard-to-find entry points, complex forms, and lack of common payment options. Any single detail can cause guests to abandon the process at the last step.",
      "Can AI recommendations directly bring orders to a hotel?\nAI recommendation solves the \"being seen\" problem. The journey from being seen to being chosen requires the hotel to have price, trust, experience, and reception fully prepared."
]
    },
    ...
    slug: "what-guests-hotels-lose-without-ai-recommendation-2026-07-10",
    featured: false,
    summary: "如果酒店没有进入 AI 给出的第一轮候选名单，失去的不只是一次曝光，而是客人在预订前、比较前、计划行程前认识酒店的机会。",
    summaryEn: "If a hotel does not enter AI's first shortlist, it loses more than exposure. It loses the opportunity to be known before guests plan, compare, and book.",
    firstLine: "很多酒店老板会觉得，客人没有看到自己，可能是广告投少了，OTA 排名不够靠前，或者价格没有别人有吸引力。",
    author: "迈创兄弟C&T",
    date: "2026-07-10",
    category: "industry-insights",
    tag: "趋势分析",
    ...
    content: [
      ...
      "迈创兄弟C&T可以帮助酒店做 AI 信息体检、官网内容整理、FAQ 与场景资料补全、餐饮会议与二次消费信息结构化、官网直订与私域入口梳理。",
    ...
    contentEn: [
      ...
      "迈创兄弟C&T helps hotels conduct AI information audits, organize official website content, complete FAQs and scenario materials, structure dining, meeting, and secondary-consumption information, and improve direct booking and private-domain entry points.",
    ...
    titleEn: "When Guests Use AI to Search for Hotels, Why Isn't Your Hotel Recommended?",
    slug: "why-ai-does-not-recommend-your-hotel-2026-07-09",
    summary: "客人开始用 AI 形成酒店候选名单。酒店没有被推荐，往往不是产品不好，而是官网、地图、OTA、评价、FAQ 和场景信息没有形成清晰、一致、可引用的公开信息。",
    summaryEn: "Guests increasingly use AI to form hotel shortlists. When a hotel is not recommended, the issue is often not product quality, but fragmented, inconsistent, or uncitable public information across websites, maps, OTAs, reviews, FAQs, and scenarios.",
    firstLine: "越来越多的客人已经养成一个新习惯：出行前先问 AI，而不是直接打开 OTA。",
    author: "迈创兄弟C&T",
    date: "2026-07-09",
    category: "industry-insights",
    tag: "行业分析",
    ...
    image: "",
    content: [
        "越来越多的客人已经养成一个新习惯：出行前先问 AI，而不是直接打开 OTA。",
        "\"帮我推荐几家适合亲子的三亚酒店，要有儿童泳池和托管服务。\"",
        "\"下周三在北京知春路附近开会，帮我找一家安静、有停车场、有会议室的中档酒店。\"",
        "\"推荐几家成都太古里周边适合情侣入住的精品酒店，预算 800 以内。\"",
        "客人问了，AI 也给了答案。问题是，你的酒店出现在那串推荐名单里了吗？",
        "大多数单体酒店老板对这个问题的第一反应是：\"我的酒店位置不差、房间也不错、OTA 评分也有 4.6，为什么 AI 不推荐？\"",
        "答案不在酒店本身好不好，而在 AI 怎么\"认识\"一家酒店。",
        "AI 的推荐逻辑和我们人的消费决策逻辑有本质不同。人订酒店可能会看几页搜索结果、对比图片和评价、凭经验判断。AI 的判断方式更像一个不带感情的信息完整性检查器：它不会为一家酒店的主观\"好\"买单，但会因为信息断层、矛盾或不可验证而直接跳过。",
        "具体来说，AI 在生成酒店推荐时，至少会同时参考以下几类信息源：OTA 平台数据、地图服务商的数据、酒店官网信息、社交媒体内容、用户评价内容、行业媒体报道以及问答类平台上的相关讨论。这几类信息源如果各自独立、互不对应，甚至关键信息互相矛盾，AI 就很难形成稳定判断。",
        "举个例子。一家酒店在 OTA 上标注了\"商务酒店\"，在地图上显示的是另一个中文名字，官网已经一年没有更新，社交媒体上找不到任何近期的顾客体验分享，大众点评的问答区有人在问\"这家店还有没有餐厅\"但没人回复。这样的信息组合，在 AI 看来就是一组低可信度信号。它不会冒险推荐，而是直接换下一家信息更完整的酒店。",
        "更具决定性的是\"场景匹配\"。AI 回答客人问题时，会优先推荐那些信息明确指向某个使用场景的酒店。比如客人问\"适合亲子的酒店\"，AI 会去找那些明确标注了儿童设施、亲子活动、家庭房型的酒店。如果你的酒店实际上有儿童泳池和亲子主题房，但没有任何一个公开渠道明确描述过这些信息，那在 AI 的视角里，你就是一家\"亲子属性未知\"的酒店，不会出现在亲子推荐里。",
        "商务出行、情侣度假、长者旅游、会议活动，每一种场景都是如此。你的酒店可能都有对应的产品和服务，但如果你没有用结构化的、机器可读的方式把它们呈现在互联网上，AI 就看不见。",
        "所以，酒店没有被 AI 推荐，不等于酒店不好。更准确的表述是：酒店的信息没有被机器读懂。",
        "这种情形短期内带来的影响，是你在一个又一个潜在客人的第一轮筛选中被淘汰。客人在问完 AI 之后往往已经有了 3 到 5 家备选，这时候即使你 OTA 排名不差，客人也不会再专门搜你。",
        "长期来看，影响更深远。AI 搜索、地图搜索、问答搜索和 OTA 前置筛选正在共同改变客人的流量入口。过去客人找酒店是自己搜、自己翻、自己比，现在越来越多的客人把筛选决定权交给了 AI 和平台算法。酒店如果不主动让自己的信息进入这些算法的有效读取范围，就等于把客源入口拱手让给了平台。时间越长，依赖越深。",
        "这不是危言耸听。OTA 用十几年改变了酒店行业的客源结构，第一批意识到线上渠道重要性的酒店用很低的成本获得了巨大的流量红利。AI 搜索带来的变化会比 OTA 更快、更彻底，因为它不仅影响比你多一层搜索筛选，还直接影响客人做出最终决策前的认知形成过程。",
        "好消息是，这个问题的解决方案并不复杂，而且不需要额外购买任何广告投放。",
        "酒店老板可以从五个维度入手做一次自查：",
        "第一，基本信息准确性。酒店名称、地址、电话、房型、设施列表，在 OTA、地图、官网、黄页等主要渠道上是否完全一致？连中文名称和英文名称的不统一，都可能导致 AI 把一家酒店误判为两个不同的实体。",
        "第二，场景信息完整性。你的酒店适合哪些客群？亲子酒店有没有写清楚儿童设施、游乐空间、亲子套餐？商务酒店有没有写明会议室数量、设备配置、停车便利性？这些信息有没有出现在至少三到五个可信的公开页面中？",
        "第三，内容可引用性。AI 倾向于引用结构清晰、署名明确、更新及时的页面。如果你的酒店信息只出现在需要登录才能查看的平台后台，或者只在 PDF 里出现过一次，AI 大概率引用不到。",
        "第四，评价与问答健康度。客人留下的评价和提问，是 AI 判断酒店真实情况的重要依据。长期不回复的问答、大量未处理的投诉、以及多个平台上对同一问题的矛盾回答，都会拉低 AI 对酒店的信任分。",
        "第五，多平台信息一致性。同一家酒店在不同平台上展示的设施数量、服务项目、价格区间如果差异很大，AI 会倾向于选择信息一致性更高的竞争对手。",
        "这五项自查做完，大多数酒店会发现自己不是缺产品，而是缺\"让 AI 读懂产品\"的信息组织方式。",
        "迈创兄弟C&T正在帮助酒店解决这个问题。我们的服务从一次 AI 信息体检开始：覆盖主流搜索平台和 AI 助手的信息抓取测试，生成一份清晰的问题清单和改进优先级。然后，我们为酒店整理和补齐官网信息、场景化 FAQ、多平台一致性内容，并提供长期的日常信息维护和 AI 可见性监测。",
        "今天，客人已经在用 AI 挑选酒店了。你的酒店需要做的不是恐慌，不是盲目投放，而是确保当 AI 替客人做出第一轮筛选时，你所有的服务和产品信息都是完整的、清晰的、能被读懂的。",
        "主动让 AI 认识你，比等客人搜到你更重要。",
        "欢迎联系 迈创兄弟C&T，从一次 AI 信息体检开始。"
    ],
    contentEn: [
        ...
        "Contact 迈创兄弟C&T and start with an AI information audit."
    ]
},

    {
      id: 614,
      type: "article",
      title: "酒店做了官网和AI资料，为什么搜索引擎还是搜不到？",
      titleEn: "Why Can Search Engines Still Miss a Hotel After It Builds a Website and AI Profile?",
      slug: "hotel-website-ai-profile-search-indexing-entry-points-2026-07-08",
      summary: "很多酒店以为做了官网、写了介绍、整理了AI资料，搜索引擎和AI就会自然读懂。真正的问题往往在抓取入口：sitemap、页面标题、结构化数据、专题索引和内容之间没有形成清晰路径。",
      summaryEn: "Many hotels assume that once they build a website, write descriptions, and prepare AI-ready materials, search engines and AI will naturally understand them. The real problem often lies in crawl entry points: sitemap coverage, page metadata, structured data, topic hubs, and content paths.",
      firstLine: "酒店老板最容易误会的一件事，是以为“内容已经放到网站上”，就等于“搜索引擎和AI已经看懂了”。",
      author: "迈创兄弟C&T",
      date: "2026-07-08",
      category: "industry-insights",
      tag: "行业分析",
      ...
      image: "",
      content: [
            "酒店老板最容易误会的一件事，是以为“内容已经放到网站上”，就等于“搜索引擎和AI已经看懂了”。",
            "现实往往不是这样。官网上线了，服务介绍写了，甚至AI资料也整理了，可在百度、Google、Bing里输入一个很具体的问题，还是找不到自己的文章；问AI“某地适合亲子、会议、长住的酒店怎么选”，AI也没有提到自己。",
            "这时不要急着判断“官网没用”或“AI不公平”。更应该先检查一个更基础的问题：你的网站有没有给搜索引擎和AI留下足够清楚的抓取入口。",
            "一句话答案是：酒店不是只需要内容，而是需要一套能被抓取、被理解、被引用的内容结构。",
            "为什么有内容还会搜不到？",
            "因为搜索引擎和AI不是像人一样慢慢逛网站。它们需要路径，需要页面关系，需要标题和摘要，需要结构化数据，也需要清楚知道一篇文章回答了什么问题。",
            "很多酒店官网的问题不在于没有页面，而在于页面之间没有组织。首页有介绍，服务页有介绍，文章页也有介绍，但它们没有告诉系统：这家酒店适合谁、解决什么问题、有哪些设施、有哪些常见问答、哪些内容是专题入口。",
            "如果网站没有稳定的sitemap，搜索引擎可能不知道新文章在哪里。如果文章页没有独立标题和摘要，系统就很难判断它回答什么问题。如果没有结构化数据，AI只能从普通段落里猜测含义。如果没有专题索引，新内容就像散落在抽屉里的纸，存在，但不好找。",
            "客户真正搜索的不是公司名，而是问题",
            "多数酒店还没有强到让客户直接搜索品牌名。潜在客户更常输入的是问题：酒店官网还有必要做吗？酒店怎么提高直订？酒店为什么被AI推荐不到？单体酒店怎么减少OTA依赖？酒店网站托管到底管什么？",
            "这意味着，MBCT和酒店客户的网站都不能只围绕公司介绍来写，而要围绕问题建立入口。每一篇文章都应该像一个答案入口，让搜索引擎和AI知道：这篇内容正在回答哪个真实问题。",
            "一个有效的网站抓取入口，至少要有五件事。",
            "第一，sitemap必须覆盖所有重要页面和文章。它相当于告诉搜索引擎：这里有哪些正式内容，哪些页面需要被发现。",
            "第二，每个文章页都要有独立metadata。标题、摘要、canonical、语言版本、开放图信息要清楚，否则搜索引擎只能靠正文猜。",
            "第三，重要页面要有JSON-LD结构化数据。酒店服务、文章、FAQ、组织信息、联系方式这些内容，用机器能读懂的方式标出来，会比单纯写在正文里更稳定。",
            "第四，要建立专题入口。比如“AI搜索可见性”“酒店官网建设”“网站托管”“OTA依赖诊断”，这些专题页能把零散文章组织起来，让系统看见内容之间的关系。",
            "第五，文章标题和首段要像真实问题。不要只写“酒店数字化趋势分析”，而要写“酒店做了官网，为什么搜索引擎还是搜不到？”这种问题更接近客户真实搜索，也更容易被AI识别为答案。",
            "MBCT的判断框架",
            "我们通常用四个维度检查酒店网站是否适合被搜索和AI读取。",
            "可发现：搜索引擎能不能通过sitemap、内部链接和索引入口找到页面。",
            "可理解：页面标题、摘要、正文结构和结构化数据，能不能说明这页回答什么问题。",
            "可引用：正文有没有清楚的方法、清单、FAQ和判断框架，方便AI摘取和引用。",
            "可转化：读者看完以后，能不能自然进入咨询、诊断、官网建设或网站托管路径。",
            "很多酒店网站缺的不是漂亮页面，而是这四件事连不起来。页面漂亮，但AI不知道它讲什么；文章写了，但搜索引擎不知道它属于哪个专题；客户看到了，但不知道下一步找谁。",
            "酒店老板可以先做一个简单自查",
            "打开网站，问自己五个问题：第一，今天新发布的文章是否已经进入sitemap？第二，文章标题是不是客户会搜索的问题？第三，页面摘要是否能在两句话内说清楚答案？第四，文章里有没有FAQ或清单？第五，读者看完是否知道MBCT或酒店能帮他解决什么？",
            "如果五个问题里有两个以上答不上来，网站就不是没有内容，而是缺少抓取入口和承接结构。",
            "MBCT可以做什么",
            "迈创兄弟C&T把这个工作称为酒店AI可见性与搜索入口建设。它包括AI信息体检、官网结构梳理、文章metadata优化、JSON-LD结构化数据、专题索引、网站托管和持续内容维护。",
            "我们不承诺控制搜索引擎，也不承诺让AI一定推荐某家酒店。但我们可以帮助酒店把公开信息整理得更清楚、更一致、更容易被抓取和理解。只有先被系统看懂，酒店才更有机会被客户看见。",
            "常见问题",
            "酒店有官网就一定能被搜索引擎收录吗？不一定。官网上线只是第一步，还要看sitemap、内部链接、页面metadata、内容质量和站长平台提交情况。",
            "AI资料和SEO文章有什么不同？AI资料更强调结构化、场景化和可引用，让AI能理解酒店适合谁、解决什么需求；SEO文章更偏向搜索关键词和页面排名，两者应该结合。",
            "网站托管只是技术维护吗？不是。真正有价值的网站托管，还包括内容更新、索引检查、专题入口维护、FAQ补充和搜索呈现复盘。",
            "单体酒店第一步应该做什么？先做一次AI可见性和搜索入口诊断，看看搜索引擎和AI现在能不能找到你、读懂你、正确描述你。",
            "迈创兄弟C&T将持续围绕酒店AI可见性、官网建设和网站托管，帮助酒店把“有内容”升级为“能被发现、能被理解、能被咨询”的长期数字资产。"
      ],
      contentEn: [
            "One of the easiest misunderstandings for hotel owners is assuming that once content is placed on a website, search engines and AI have already understood it.",
...

    {
      ...
      summary: "很多酒店官网有人看，却很少有人直接订。问题往往不是 OTA 太强，而是官网没有把价格、权益、取消、发票和联系方式讲清楚。AI 搜索时代，官网要先让客人和 AI 都读懂，才有机会承接直订。",
      summaryEn: "Many hotel websites receive visitors but still fail to convert direct bookings. The issue is often not that OTAs are too strong, but that the website does not clearly answer pricing, benefits, cancellation, invoice, and contact questions before guests decide.",
...

    {
      ...
      summary: "客人越来越习惯先问 AI，再去 OTA 比价。酒店如果官网、地图、OTA 和社媒信息分散，优势场景又讲不清，AI 可能不是不认可酒店，而是根本没有读懂酒店适合谁。",
      summaryEn: "Guests increasingly ask AI before comparing hotels on OTAs. If website, map, OTA, and social information are fragmented or vague, AI may skip the hotel not because it is weak, but because it cannot understand who the hotel is for.",
...

    {
      ...
      summary: "旺季客流上来了，酒店却可能更累、更乱、更容易出差评。原因不只是人多，而是家庭客、夜间消费、早餐高峰和一线响应同时压上来。先看服务承载力，再谈涨价和收入增长。",
      summaryEn: "Peak-season traffic can make a hotel busier, messier, and more vulnerable to complaints. The issue is not only more guests, but family demand, night consumption, breakfast peaks, and front-line response pressure arriving together.",
      firstLine: "很多酒店老板都有过这种感觉：游客确实多了，前台也忙了，房间看起来更好卖了，可一算账，心里并没有轻松多少。早餐排队、停车投诉、房间没及时准备好、夜里客人集中回店、员工一整天都在补救。旺季来了，酒店没有变得更从容，反而更像被客流推着跑。",
      author: "迈创兄弟C&T",
      date: "2026-07-05",
      category: "industry-insights",
      tag: "趋势分析",
...

    {
      ...
      summary: "AI 搜索会带来更多咨询，但咨询多不等于成交多。酒店如果来一个报一个，很容易把高价值企业客户淹没在普通询价里。先分级、再画像、再跟进，才能把真正有意向的客户留下来。",
      summaryEn: "AI search can bring more inquiries, but more inquiries do not automatically mean more bookings. If every inquiry receives the same quote, valuable corporate leads get buried. Hotels need lead scoring and client profiles before follow-up.",
  ...
  const reports = [
    ...
    },
    {
      ...
      titleEn: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      slug: "hotel-search-traffic-2026-ai-overviews-zero-click-2026-06-30",
      summary: "副题：客人搜得到你，却不点进来。酒店真正要补的，是 AI 摘要里的位置、自有入口里的承接、咨询路径里的方便。",
      summaryEn: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      firstLine: "副题：客人搜得到你，却不点进来。酒店真正要补的，是 AI 摘要里的位置、自有入口里的承接、咨询路径里的方便。",
      author: "迈创兄弟C&T",
      date: "2026-06-30",
      readTime: 12,
      tag: "行业报告",
    ...
    },
    {
      id: 502,
      type: "report",
      title: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      titleEn: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      slug: "hotel-search-traffic-2026-ai-overviews-zero-click-2026-06-30-en",
      summary: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      summaryEn: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
      firstLine: "2026 Hotel Search Traffic Report: How AI Overviews and Zero-Click Search Are Reshaping How Guests Find Hotels",
    ...
    },
    {
      ...
      summary: "需求来了以后，酒店最容易为了成交先降价。真正决定利润质量的不是询盘数量，而是能不能先判断需求质量、渠道成本和服务承载力，再设置清楚的报价底线。没有报价纪律，新增需求也可能变成低利润订单。",
      summaryEn: "When new demand arrives, hotels are often tempted to cut prices first. Profit quality depends not on inquiry volume, but on judging demand quality, channel cost, and service capacity before setting a clear pricing floor.",
...

    {
      ...
      summary: "一线经营者觉得酒店越来越难，投资人却仍在看项目。两者并不矛盾：经营端看到的是利润变薄、团队更累，资产端看到的是存量重构、低效物业和专业化运营机会。关键在于谁能把酒店从资产买卖做成经营能力。",
      summaryEn: "Operators see thinner margins and harder work, while investors still see asset restructuring and professional operating opportunities. The contradiction disappears once hotel investment is viewed not only as property buying, but as operating capability.",
  ...
  const cases = [
    ...
    },
    {
      id: 471,
      type: "case",
      title: "酒店的资产不只在房间里：如何把一次入住沉淀为客户资产",
      titleEn: "Hotel Assets Are Not Only Rooms: Turning One Stay into Long-Term Customer Value",
      slug: "hotel-assets-customer-value-one-stay-2026-06-28",
      summary: "酒店真正可持续的资产不只在房间。还包括被客人记住的体验、可再次触达的关系、可被 AI 与搜索系统读取的信息、可维护更新的内容、可反哺经营的数据五类。多数酒店只看入住率，忽略了客户资产累积。本文给出五维拆解与三步落地路径。",
      summaryEn: "Hotel assets that compound over time are not only rooms. They include remembered experience, re-touchable relationships, AI-readable information, updatable content, and decision-feeding data. Most hotels track occupancy but ignore customer-asset accumulation.",
      firstLine: "酒店真正可持续的资产不只在房间。还包括被客人记住的体验、可再次触达的关系、可被 AI 与搜索系统读取的信息、可维护更新的内容、可反哺经营的数据五类。多数酒店只看入住率，忽略了客户资产累积。",
      author: "迈创兄弟C&T",
      date: "2026-06-28",
      readTime: 10,
      tag: "管享精道",
    ...
    },
    {
      id: 472,
      type: "report",
      title: "酒店业客户资产经营现状：从流量依赖到客户关系资产化的转型路径",
      titleEn: "Customer-Asset Operations in the Hotel Industry",
      slug: "hotel-industry-customer-asset-operations-2026-06-28",
      summary: "客户资产正在替代客房资产，成为酒店行业的核心竞争维度。",
      summaryEn: "Customer assets are replacing room assets as the core competitive dimension in the hotel industry.",
      firstLine: "客户资产正在替代客房资产，成为酒店行业的核心竞争维度。",
      author: "迈创兄弟C&T",
      date: "2026-06-28",
      readTime: 18,
      tag: "行业资讯",
    ...
    },
    {
      id: 473,
      type: "case",
      title: "Hotel Assets Are Not Only Rooms: Turning One Stay into Long-Term Customer Value",
      titleEn: "Hotel Assets Are Not Only Rooms: Turning One Stay into Long-Term Customer Value",
      slug: "hotel-assets-customer-value-one-stay-2026-06-28-en",
      summary: "Hotel assets that compound over time are not only rooms.",
      summaryEn: "Hotel assets that compound over time are not only rooms.",
      firstLine: "Hotel assets that compound over time are not only rooms.",
      author: "MarvelBros C&T",
      date: "2026-06-28",
      readTime: 10,
      tag: "Lean Insights",
    ...
    },
{
      ...
      summary: "咨询量、订单量、入住率都上去了，利润却没有跟上。问题常常不是市场不好，也不是销售不努力，而是酒店没有算清净贡献、客户分级、报价权限和服务成本。接单不等于经营，结构错了，越忙越不赚钱。",
      summaryEn: "More inquiries, more orders, and higher occupancy do not guarantee more profit. Without net contribution, lead tiers, quote authority, and service-cost discipline, a hotel may become busier while earning less.",
...

    {
      ...
      summary: "周末满房看起来是好事，但如果翻房、早餐、前台响应和服务承诺都被压到极限，差评往往会在周一集中出现。满房不是终点，而是服务系统的压力测试。",
      summaryEn: "A sold-out weekend looks like good news, but if housekeeping, breakfast, front desk response, and service promises are pushed beyond capacity, negative reviews often appear on Monday. Full occupancy is a stress test, not the finish line.",
