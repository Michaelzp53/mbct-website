  ...
  const cases = [
    {
      ...
      firstLine: '张总在杭州经营一家120间客房的会议型酒店，他一直很重视数据。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '技术应用',
    ...
    },
    {
      ...
      firstLine: '王总在成都经营一家80间客房的精品酒店，2019年他花了8万块上了一套"智慧酒店系统"。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '技术应用',
    ...
    },
    {
      ...
      firstLine: '刘总在南京经营一家120间客房的商务酒店，员工60人。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '团队发展',
    ...
    },
    {
      ...
      firstLine: '周经理在宁波经营一家68间客房的城市商务酒店，属于单体店，没有连锁品牌背书。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '团队发展',
    ...
    },
    {
      ...
      firstLine: '张总在成都新开了一家80间客房的精品酒店，开业前三个月开始选PMS系统。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '筹建筹备',
    ...
    },
    {
      ...
      firstLine: '孙总在杭州投资了一个酒店改造项目，物业是之前的一个快捷酒店，2200平米，他想把改成中端精选酒店。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '筹建筹备',
    ...
    },
    {
      ...
      firstLine: '陈总在成都经营一家100间客房的商务酒店，他在这个行业干了15年。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '运营管理',
    ...
    },
    {
      ...
      firstLine: '张总在杭州经营一家150间客房的会议型酒店，客源结构是60%会议团、30%旅游散客、10%长住客。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '运营管理',
    ...
    },
    {
      ...
      firstLine: '李总在南京经营一家98间客房的经济型酒店，位置不错，靠近地铁口，客源以旅游和商务散客为主。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '市场营销',
    ...
    },
    {
      ...
      firstLine: '赵总在重庆经营一家65间客房的精品民宿，开业两年，客源结构一直不健康——80%依赖携程，20%来自walk-in。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '市场营销',
    ...
    },
    {
      ...
      firstLine: '王总在2019年收购了一栋上海外高桥的物业，改造成精品酒店，估值2.3亿。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '投资决策',
    ...
    },
    {
      ...
      firstLine: '陈总在苏州看中了一个地铁上盖物业，3500平米，位置绝佳。他找了三个 "懂行" 的朋友帮忙参谋。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '投资决策',
    ...
    },
    {
      ...
      firstLine: '陈总在成都经营一家150间客房的商务酒店，员工编制58人。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '成本管控',
    ...
    },
    {
      ...
      firstLine: '方总在武汉经营一家200间客房的会议型酒店，客源结构是：60%会议团、30%旅游散客、10%长住客。',
      author: '迈创兄弟',
      date: '2026-05-10',
      readTime: '15分钟',
      tag: '成本管控',
