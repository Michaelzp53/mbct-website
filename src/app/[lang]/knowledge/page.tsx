...
export default async function KnowledgePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articles = [
    ...
    content: [
        ...
        "迈创兄弟C&T（MarvelBros C&T）正在帮助酒店解决这个问题。我们的服务从一次 AI 信息体检开始：覆盖主流搜索平台和 AI 助手的信息抓取测试，生成一份清晰的问题清单和改进优先级。然后，我们为酒店整理和补齐官网信息、场景化 FAQ、多平台一致性内容，并提供长期的日常信息维护和 AI 可见性监测。",
        "今天，客人已经在用 AI 挑选酒店了。你的酒店需要做的不是恐慌，不是盲目投放，而是确保当 AI 替客人做出第一轮筛选时，你所有的服务和产品信息都是完整的、清晰的、能被读懂的。",
        "主动让 AI 认识你，比等客人搜到你更重要。",
        "欢迎联系 迈创兄弟C&T（MarvelBros C&T），从一次 AI 信息体检开始。"
    ],
    contentEn: [
...

    {
      ...
      content: [
            ...
            "迈创兄弟C&T（MarvelBros C&T）将持续围绕酒店AI可见性、官网建设和网站托管，帮助酒店把“有内容”升级为“能被发现、能被理解、能被咨询”的长期数字资产。"
      ],
      contentEn: [
