  ...
  const articles = [
    {
      ...
      titleEn: 'Membership Is Growing. Why Does the Front Desk Still Fail to Recognise Returning Guests?',
      slug: 'hotel-returning-guest-recognition-workflow-2026-08-14',
      summary: '会员注册不等于回头客识别。用身份、偏好、权益和决策权四项检查，加上两周五十位客人测试，修复前台识别链。',
      summaryEn: 'Membership does not guarantee recognition. Use identity, preference, benefit and decision-right checks, then test the workflow with 50 returning guests over two weeks.',
      firstLine: '会员数上涨，不等于回头客识别能力上涨。',
      author: '迈创兄弟C&T',
      date: '2026-08-14',
      category: 'operating-governance',
      tag: isZh ? '酒店经营治理' : 'Operating Governance',
      tagColor: 'bg-[#c67829]',
    ...
    },
    {
      id: 648,
      type: 'article',
      title: '会员体系越做越大，独立酒店该不该自建积分？',
      titleEn: 'As Hotel Loyalty Platforms Scale, Should Independent Hotels Build Their Own Points Programme?',
      slug: 'independent-hotel-points-programme-2026-08-14',
      summary: '大型集团的会员规模不能直接证明单店积分有效。独立酒店应先验证识别、权益兑现和净复购，再决定是否投资积分体系。',
      summaryEn: 'Global loyalty scale does not prove that points will work for one property. Independent hotels should validate recognition, benefit fulfilment and net repeat demand before investing.',
      firstLine: '多数独立酒店不应先从积分开始，而应先证明关系能够被识别、兑现并形成净复购。',
      author: '迈创兄弟C&T',
      date: '2026-08-14',
    ...
    },
    {
      id: 646,
      type: 'article',
      title: '客人问题转了几个部门，为什么最后总要前台兜底',
      titleEn: 'Why the Front Desk Keeps Owning Problems That Belong to the Whole Hotel',
      slug: 'hotel-front-desk-cross-department-ownership-2026-08-13',
      summary: '前台应该是问题入口，不应自动成为所有问题的最终责任人。用事实、主责、协作、时限和验证五栏，建立跨部门客诉责任链。',
      summaryEn: 'The front desk should be the entry point, not the automatic final owner. Use facts, ownership, collaboration, timing and verification to build a cross-department guest-issue chain.',
      firstLine: '前台应该是问题入口，但不应该自动成为所有问题的最终责任人。',
      author: '迈创兄弟C&T',
      date: '2026-08-13',
      category: 'operating-governance',
      tag: isZh ? '酒店经营治理' : 'Operating Governance',
    ...
    },
    {
      id: 645,
      type: 'article',
      title: '暑期客流之后，酒店为什么不能把9月直接当成淡季',
      titleEn: 'Why September Demand Should Not Be Treated as a Simple Hotel Low Season',
      slug: 'hotel-september-demand-structure-2026-08-13',
      summary: '暑期结束不等于需求消失。把客源、提前期、入住日型、产品承载和渠道净收入拆开，用90天需求桥接法决定9月该降价、缩产品还是调整排班。',
      summaryEn: 'The end of summer is not the end of demand. Separate source mix, lead time, day-of-week patterns, product fit and net channel income before deciding whether September needs lower rates, fewer products or different staffing.',
      firstLine: '暑期结束不等于需求消失，9月先看需求结构，再决定是否收缩。',
      author: '迈创兄弟C&T',
      date: '2026-08-13',
      category: 'industry-insights',
      tag: isZh ? '行业分析' : 'Industry Analysis',
