...
说到这，不得不提一下我们迈创兄弟C&T在做的事。作为酒店业AI赋能的践行者，我们帮助酒店通过数据洞察精准识别客群需求，通过智能系统提升运营效率，通过数字化工具创造个性化体验。
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link href={`/${lang}/knowledge`} className="inline-flex items-center text-muted-foreground hover:text-[#8b5cf6] transition-colors mb-8">
          ...
          <div className="p-8 border-b border-gray-800">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <button className="p-2 rounded-lg bg-muted text-muted-foreground hover:text-[#8b5cf6] transition-colors"><Share2 className="w-4 h-4" /></button>
                <button className="p-2 rounded-lg bg-muted text-muted-foreground hover:text-[#8b5cf6] transition-colors"><Bookmark className="w-4 h-4" /></button>
              </div>
            </div>
          </div>
