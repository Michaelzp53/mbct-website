...
import { ArrowLeft, MessageCircle, ThumbsUp, ThumbsDown, Eye, CheckCircle, XCircle, Clock } from 'lucide-react'
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                      {q.pillar && (
                        <span className="px-2 py-1 rounded-md bg-muted">
                          {pillarMap[q.pillar] || q.pillar}
                        </span>
                      )}
                      {q.waste_types && q.waste_types.length > 0 && (
                        <span className="px-2 py-1 rounded-md bg-muted">
                      ...
                      {q.nickname && (
                        <span>提问者：{q.nickname}</span>
                      )}
                      {q.hotel_name && (
                        <span>酒店：{q.hotel_name}</span>
                      )}
                    </div>
                  </div>
